...
import { adminData, updateData } from '../../Services/Action/Products.action';
...
export default function AddProducts() {
    ...
    const [formInput, setFormInput] = useState(product);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await dispatch(updateData(formInput.id, formInput));
        navigate('/Products')
    }
                ...
                <Row>
                    <Box sx={{border:'1px solid skyblue', padding:'30px', borderRadius:'30px'}}>
                        ...
                        <Col md={{ span: 6, offset: 3 }}>
                            ...
                            <Box sx={{ borderBottom: ' 1px solid #000' , color:'red', textAlign:'center' ,margin:'20px'}}> 
                                <h4>  ~: EDIT PRODUCT :~ </h4>
                            </Box>
                            ...
                            <Form onSubmit={handleSubmit} className="mt-4 "  border="info">
                                <Row className="mb-3">
                                    <Col>
                                        ...
                                        type="text" name='name' value={formInput.name} onChange={handleChange} />
                                    ...
                                    <Col>
                                        ...
                                        type="text" name='price' value={formInput.price} onChange={handleChange} />
